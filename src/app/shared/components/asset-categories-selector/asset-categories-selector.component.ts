...
// import { AssetCategoryDto, AssetCategoriesClient } from '../../../core/services/api-client';
...
//     loadCategories() {
//         this.loading = true;
//         this.assetCategoriesClient.getAssetCategory().subscribe({
//             next: (data) => {
...
//     mapToTreeNodes(data: AssetCategoryDto[]): TreeNode[] {
